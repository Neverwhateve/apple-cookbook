    ...
    <main className="mx-auto grid max-w-7xl gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[minmax(0,760px)_minmax(280px,1fr)]">
      ...
      <aside className="space-y-6">
        <section className="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-950">
          <h2 className="text-base font-semibold text-zinc-950 dark:text-zinc-50">Metadata</h2>
          <dl className="mt-4 space-y-3 text-sm">
            ...
            <div>
              <dt className="text-zinc-500">Source Count</dt>
        ...
        <section className="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-950">
          <h2 className="text-base font-semibold text-zinc-950 dark:text-zinc-50">Tags</h2>
        ...
        {related.length > 0 ? (
          <section>
            <h2 className="mb-3 text-base font-semibold text-zinc-950 dark:text-zinc-50">Related Articles</h2>
