...
export default function CategoriesPage() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
      <h1 className="text-3xl font-semibold text-zinc-950 dark:text-zinc-50">Categories</h1>
      <p className="mt-3 max-w-2xl text-zinc-600 dark:text-zinc-400">
        Device, service, and Retail case areas. Articles remain Markdown files under the matching cookbook folders.
      </p>
      <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {categories.map((category) => (
          ...
          >
            ...
            <div className="mt-2 text-sm text-zinc-500">{category.items.length} articles</div>
          </Link>
        ))}
      </div>
    </main>
